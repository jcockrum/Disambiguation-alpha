  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved scene as @scene" do
        ...
        post :create, {:scene => { "name" => "invalid value" }}, valid_session
        assigns(:scene).should be_a_new(Scene)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested scene" do
        ...
        Scene.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => scene.to_param, :scene => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the scene as @scene" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Scene.any_instance.stub(:save).and_return(false)
        put :update, {:id => scene.to_param, :scene => { "name" => "invalid value" }}, valid_session
        assigns(:scene).should eq(scene)
      end
